    ...
    <div class="bg-black">
        ...
        <div class="grid grid-cols-2">
            @foreach ($rates as $key => $rate)
                @if ($key%2 ==0)
                    <div>
                        <div class="flex justify-center py-2 ga">
                            <div class="flex flex-col md:flex-row md:w-4/5 rounded-lg bg-white shadow-lg">
                                <img class="rounded-lg w-60 h-80 mb-4  p-2" src="{{env('APP_URL').'/storage/'.$rate->driver->image }}" alt=""/>
                                <div class="p-6 flex flex-col justify-start">
                                    ...
                                    <div  class="flex  justify-center items-center ml-2">
                                        <span class="text-gray-900 text-sm font-medium mb-2 text-center">Cantidad de viajes: {{$rate->arrivals  }} </span>
                                    </div>
                                    <div class="flex  justify-center space-x-2">
                                        <a href="{{$rate->driver->facebook}}">
                    ...
                    <div>
                        <div class="flex justify-center py-2">
                            <div class="flex flex-col md:flex-row md:w-4/5 rounded-lg bg-white shadow-lg">
                                <img class="rounded-lg w-60 h-80 mb-4  p-2" src="{{env('APP_URL').'/storage/'.$rate->driver->image }}" alt=""/>
                                <div class="p-6 flex flex-col justify-cen">
                                    <h4 class="text-gray-900 text-xl font-medium mb-2  text-center	"># {{$key+1 }}</h4>
